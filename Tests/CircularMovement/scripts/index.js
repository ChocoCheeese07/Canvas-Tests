...
var rect1 = new CGE.Circle(canvas.width / 2, canvas.height / 2, 0, 0, 50, "blue");
rect1.detectEdges = false;
rect1.angle = Math.PI;
rect1.pathRadius = 50;
var rect2 = new CGE.Circle(canvas.width / 2, canvas.height / 2, 0, 0, 50, "red");
rect2.detectEdges = false;
rect2.angle = 0;
rect2.pathRadius = 110;
var rect3 = new CGE.Circle(canvas.width / 2, canvas.height / 2, 0, 0, 50, "blue");
rect3.detectEdges = false;
rect3.angle = Math.PI;
rect3.pathRadius = 170;
var rect4 = new CGE.Circle(canvas.width / 2, canvas.height / 2, 0, 0, 50, "red");
rect4.detectEdges = false;
rect4.angle = 0;
rect4.pathRadius = 230;
var rect5 = new CGE.Circle(canvas.width / 2, canvas.height / 2, 0, 0, 50, "blue");
