var CGE = {
  ...
  CircleRectCollision(circle, rect) {
    ...
    if(circle.pos.x < rect.pos.x) testX = left;
    if(circle.pos.x > rect.pos.x) testX = right;
    if(circle.pos.y < rect.pos.y) testY = above;
    if(circle.pos.y > rect.pos.y) testY = below;
